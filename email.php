...
try {
    ...
    //Recipients
    $mail->setFrom('admin@vishwavedika.net', 'Vishwavedika Archives');
    ...
    A zip generated link to download todays archive!
    <a href="v2.vishwavedika.net/archives/'.$date.'.zip">v2.vishwavedika.net/archives/'.$date.'.zip</a>';
