...
<div class="sidebar" id="sidebar_toggle" style="background: #a4133c;">
    ...
    <br><br><br><br>
    <button class="sidebar_link2" onclick="panel11()"><i class="fas fa-bars" style="padding-right: 15px;"></i> Hide Navigation</button>
</div>
<div class="header" id="header_toggle">
    <div style="padding: 10px;">
        ...
        <div class='mobile_show'>
            <button id="hide_btn" style="background: #fff; float: left;  border: 1px solid #eee; padding: 10px; margin-top: 5px; color: #888;" onclick="panel22()"><i class="fas fa-bars"></i></button>
        </div>
...
<div id='body_area'>
    <div id="area_1" style="display: block;">
        <div style="padding: 20px 60px;">
            ...
            ?>
            <a href="../<?php echo $search_name_first ?>">
                <div style="border: 2px solid #2b2d42; float: left; margin-right: 15px; margin-top: 15px; background: #2b2d42; box-shadow: 1px 1px 8px #888; width: 300px; height: 120px; border-radius: 4px;">
                    <div style="padding: 20px">
